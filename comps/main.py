...
# # Tiktoken encoding - using 'cl100k_base' as an approximation for Llama models
...
#             # More robust check for first token
...
#                     "metrics": {
#                         "ttft": ttft if ttft > 0 else e2e_latency,  # Fallback to e2e if ttft not captured
...
#         metrics_json = json.dumps({
#             "metrics": {
#                 "ttft": ttft if ttft > 0 else e2e_latency,  # Fallback
#                 "output_tokens": token_count,
#                 "throughput": throughput,
#                 "e2e_latency": e2e_latency
#             }
...
#             # Calculate metrics for non-streaming case
#             if not stream_opt:
...
#                     "ttft": e2e_latency,  # Set ttft to e2e_latency for non-streaming
#                     "e2e_latency": e2e_latency,
#                     "completed": True,
#                     "output_tokens": token_count,
#                     "throughput": throughput
...
#             response_dict["metrics"] = metrics_data  # Include metrics in the response
            ...
            if isinstance(rag_response, StreamingResponse):
                if stream:
                    ...
                    if provided_metrics:
                        ...
                        print("DEBUG: No provided metrics; using defaults and skipping save.")
